...
export async function questionRoutes(app: FastifyInstance) {
  ...
  app.post('/boxes/:box_id/questions', {
    preHandler: questionRateLimit,
  }, async (request: FastifyRequest<{
    Params: { box_id: string }
  }>, reply: FastifyReply) => {
  ...
  app.get('/owner/questions', {
    preHandler: [authenticate],
  }, async (request: FastifyRequest<{
    Querystring: { status?: string; box_id?: string; limit?: string; offset?: string }
  }>, reply: FastifyReply) => {
  ...
  app.post('/questions/:question_id/open', {
    preHandler: [authenticate],
  }, async (request: FastifyRequest<{
    ...
    await prisma.question.update({
      ...
      data: {
        ...
        openedSig: body.opened_sig
          ? Buffer.from(fromBase64Url(body.opened_sig))
          : null,
      },
    });
